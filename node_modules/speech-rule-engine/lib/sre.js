...
sre.AbstractHighlighter.prototype.addEvents=function(a,b){for(var c=this.getMactionNodes(a),d=0,e;e=c[d];d++)for(var f in b)e.addEventListener(f,b[f])};sre.AbstractHighlighter.prototype.getMactionNodes=function(a){return a.getElementsByClassName(this.mactionName)};sre.AbstractHighlighter.prototype.isMactionNode=function(a){return a.className.match(new RegExp(this.mactionName))};sre.AbstractHighlighter.prototype.resetState=function(a){delete this.state_[a]};
...
"self::*",'name(../..)="punctuated"','name(../../../..)="tensor"','../../@role="rightsuper"')};sre.AbstractionRules=function(){sre.AbstractionRules.initAbstractionRules_()};goog.addSingletonGetter(sre.AbstractionRules);sre.AbstractionRules.mathStore=sre.MathmlStore.getInstance();sre.AbstractionRules.defineRule_=goog.bind(sre.AbstractionRules.mathStore.defineRule,sre.AbstractionRules.mathStore);sre.AbstractionRules.defineRuleAlias_=goog.bind(sre.AbstractionRules.mathStore.defineRulesAlias,sre.AbstractionRules.mathStore);
...
"ancestor::fraction|ancestor::punctuated|ancestor::fenced|ancestor::root|ancestor::sqrt|ancestor::relseq|ancestor::multirel|self::tensor[@embellished]"].concat(c);sre.MathspeakRules.defineRuleAlias_.apply(null,d)}};sre.CombinedStore=function(){};goog.addSingletonGetter(sre.CombinedStore);sre.CombinedStore.mathStore=sre.MathmlStore.getInstance();sre.CombinedStore.mathStore.initialize=function(){sre.MathmlStoreRules.getInstance();sre.SemanticTreeRules.getInstance();sre.MathspeakRules.getInstance();sre.ClearspeakRules.getInstance();sre.AbstractionRules.getInstance();sre.PrefixRules.getInstance();sre.CombinedStore.getInstance().updateEngine()};
...
sre.EnrichMathml.computePrefix_=function(a){var b=sre.SemanticTree.fromRoot(a),c=sre.XpathUtil.evalXPath('.//*[@id="'+a.id+'"]',b.xml())[0];return c?sre.Engine.getInstance().runInSetting({domain:"prefix",style:"default",strict:!0,cache:!1,speech:!0},function(){return sre.SpeechRuleEngine.getInstance().evaluateNode(c)}):[]};
...
module.exports.pprintXML=sre.DomUtil.formatXml;sre.System.getInstance().setupEngine({mode:sre.Engine.Mode.ASYNC});
