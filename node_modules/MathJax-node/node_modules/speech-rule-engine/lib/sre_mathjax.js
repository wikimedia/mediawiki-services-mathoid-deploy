...
sre.XpathUtil.prefixNamespace=function(a){if(a&&a._nsMap){for(var b=a.attributes,c=0,d;d=b[c];c++)if("xmlns"==d.name&&!d.prefix){var e=sre.XpathUtil.prefixes_[a.namespaceURI];e&&(d.prefix=d.name,d.localName=e,d.nodeName=d.nodeName+":"+e)}a.namespaceURI&&(a._nsMap[e]=a.namespaceURI,delete a._nsMap[""],sre.XpathUtil.defaultNamespace_(a))}};sre.DomUtil={};sre.DomUtil.toArray=function(a){for(var b=[],c=0;c<a.length;c++)b.push(a[c]);return b};sre.DomUtil.trimInput_=function(a){return a.replace(/>\s+</g,"><").trim()};
