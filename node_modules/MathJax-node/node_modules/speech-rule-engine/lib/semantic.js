...
sre.XpathUtil.prefixNamespace=function(a){if(a&&a._nsMap){for(var b=a.attributes,c=0,d;d=b[c];c++)if("xmlns"==d.name&&!d.prefix){var e=sre.XpathUtil.prefixes_[a.namespaceURI];e&&(d.prefix=d.name,d.localName=e,d.nodeName=d.nodeName+":"+e)}a.namespaceURI&&(a._nsMap[e]=a.namespaceURI,delete a._nsMap[""],sre.XpathUtil.defaultNamespace_(a))}};sre.DomUtil=function(){};sre.DomUtil.toArray=function(a){for(var b=[],c=0;c<a.length;c++)b.push(a[c]);return b};sre.DomUtil.removeEmpty=function(a){return a.filter(function(a){return a})};sre.DomUtil.trimInput_=function(a){return a.replace(/>\s+</g,"><").trim()};
sre.DomUtil.parseInput=function(a,b){var c=b||Error,d=new sre.SystemExternal.xmldom.DOMParser,e=sre.DomUtil.trimInput_(a);if(!e)throw new c("Empty input!");try{var f=d.parseFromString(e,"text/xml").documentElement;sre.XpathUtil.prefixNamespace(f);return f}catch(g){throw new c("Illegal input: "+g.message);}};
...
sre.SemanticTree.Node.prototype.toString=function(a){var b=new sre.SystemExternal.xmldom.XMLSerializer,c=(new sre.SystemExternal.xmldom.DOMParser).parseFromString("//","text/xml");return b.serializeToString(this.xml(c,a))};sre.SemanticTree.Node.prototype.xmlAttributes_=function(a){a.setAttribute("role",this.role);this.font!=sre.SemanticAttr.Font.UNKNOWN&&a.setAttribute("font",this.font);this.embellished&&a.setAttribute("embellished",this.embellished);a.setAttribute("id",this.id)};
sre.SemanticTree.prototype.createNode_=function(){return new sre.SemanticTree.Node(this.idCounter_++)};sre.SemanticTree.prototype.replaceNode_=function(a,b){var c=a.parent;c?c.replaceChild_(a,b):this.root=b};sre.SemanticTree.Node.prototype.updateContent_=function(a){a=a.trim();if(this.textContent!=a){var b=sre.SemanticAttr.lookupMeaning(a);this.textContent=a;this.role=b.role;this.type=b.type;this.font=b.font}};
sre.SemanticTree.Node.prototype.addMathmlNodes_=function(a){for(var b=0,c;c=a[b];b++)-1==this.mathml.indexOf(c)&&this.mathml.push(c)};sre.SemanticTree.Node.prototype.removeMathmlNodes_=function(a){for(var b=this.mathml,c=0,d;d=a[c];c++)d=b.indexOf(d),-1!=d&&goog.array.removeAt(b,d);this.mathml=b};sre.SemanticTree.Node.prototype.appendChild_=function(a){this.childNodes.push(a);this.addMathmlNodes_(a.mathml);a.parent=this};
...
sre.SemanticTree.prototype.parseMathml_=function(a){var b=sre.DomUtil.toArray(a.childNodes);switch(sre.SemanticUtil.tagName(a)){case "SEMANTICS":if(0<b.length){b=this.parseMathml_(b[0]);break}case "MATH":case "MROW":case "MPADDED":case "MSTYLE":return b=sre.SemanticUtil.purgeNodes(b),b=1==b.length?this.parseMathml_(b[0]):this.processRow_(this.parseMathmlChildren_(b)),b.mathml.unshift(a),b;case "MFRAC":b=this.makeFractionNode_(this.parseMathml_(b[0]),this.parseMathml_(b[1]));break;case "MSUB":case "MSUP":case "MSUBSUP":case "MOVER":case "MUNDER":case "MUNDEROVER":b=
this.makeLimitNode_(sre.SemanticUtil.tagName(a),this.parseMathmlChildren_(b));break;case "MROOT":b=this.makeBranchNode_(sre.SemanticAttr.Type.ROOT,[this.parseMathml_(b[1]),this.parseMathml_(b[0])],[]);break;case "MSQRT":b=this.parseMathmlChildren_(sre.SemanticUtil.purgeNodes(b));b=this.makeBranchNode_(sre.SemanticAttr.Type.SQRT,[this.processRow_(b)],[]);break;case "MTABLE":b=this.makeBranchNode_(sre.SemanticAttr.Type.TABLE,this.parseMathmlChildren_(b),[]);sre.SemanticTree.tableIsMultiline_(b)&&this.tableToMultiline_(b);
break;case "MTR":b=this.makeBranchNode_(sre.SemanticAttr.Type.ROW,this.parseMathmlChildren_(b),[]);b.role=sre.SemanticAttr.Role.TABLE;break;case "MTD":b=this.parseMathmlChildren_(sre.SemanticUtil.purgeNodes(b));b=this.makeBranchNode_(sre.SemanticAttr.Type.CELL,[this.processRow_(b)],[]);b.role=sre.SemanticAttr.Role.TABLE;break;case "MS":case "MTEXT":b=this.makeLeafNode_(a);b.type=sre.SemanticAttr.Type.TEXT;"MS"===sre.SemanticUtil.tagName(a)&&(b.role=sre.SemanticAttr.Role.STRING);sre.SemanticTree.exprFont_(b);
break;case "MI":b=this.makeIdentifierNode_(a);break;case "MN":b=this.makeLeafNode_(a);if(b.type==sre.SemanticAttr.Type.UNKNOWN||b.type==sre.SemanticAttr.Type.IDENTIFIER)b.type=sre.SemanticAttr.Type.NUMBER;sre.SemanticTree.numberRole_(b);sre.SemanticTree.exprFont_(b);break;case "MO":b=this.makeLeafNode_(a);b.type==sre.SemanticAttr.Type.UNKNOWN&&(b.type=sre.SemanticAttr.Type.OPERATOR);break;case "MFENCED":b=this.processMfenced_(a,this.parseMathmlChildren_(sre.SemanticUtil.purgeNodes(b)));b=this.processTablesInRow_([b])[0];
break;case "MENCLOSE":b=this.parseMathmlChildren_(sre.SemanticUtil.purgeNodes(b));b=this.makeBranchNode_(sre.SemanticAttr.Type.ENCLOSE,[this.processRow_(b)],[]);b.role=a.getAttribute("notation")||sre.SemanticAttr.Role.UNKNOWN;break;case "MMULTISCRIPTS":b=this.processMultiScript_(b);break;case "NONE":b=this.makeEmptyNode_();break;default:b=this.makeUnprocessed_(a)}b.mathml.unshift(a);b.mathmlTree=a;return b};
...
sre.SemanticTree.getEmbellishedInner_=function(a){return a&&a.embellished&&0<a.childNodes.length?sre.SemanticTree.getEmbellishedInner_(a.childNodes[0]):a};sre.SemanticMathml=function(){};sre.SemanticMathml.SETTINGS={collapsed:!0,implicit:!0};sre.SemanticMathml.ATTRIBUTE_PREFIX_="data-semantic-";
sre.SemanticMathml.Attribute={ADDED:sre.SemanticMathml.ATTRIBUTE_PREFIX_+"added",CHILDREN:sre.SemanticMathml.ATTRIBUTE_PREFIX_+"children",COLLAPSED:sre.SemanticMathml.ATTRIBUTE_PREFIX_+"collapsed",CONTENT:sre.SemanticMathml.ATTRIBUTE_PREFIX_+"content",FONT:sre.SemanticMathml.ATTRIBUTE_PREFIX_+"font",ID:sre.SemanticMathml.ATTRIBUTE_PREFIX_+"id",OPERATOR:sre.SemanticMathml.ATTRIBUTE_PREFIX_+"operator",PARENT:sre.SemanticMathml.ATTRIBUTE_PREFIX_+"parent",ROLE:sre.SemanticMathml.ATTRIBUTE_PREFIX_+"role",
TYPE:sre.SemanticMathml.ATTRIBUTE_PREFIX_+"type"};sre.SemanticMathml.formattedOutput=function(a,b,c,d){d=d||!1;sre.SemanticMathml.formattedOutput_(a,"Original MathML",d);sre.SemanticMathml.formattedOutput_(c,"Semantic Tree",d);sre.SemanticMathml.formattedOutput_(b,"Semantically enriched MathML",d)};sre.SemanticMathml.formattedOutput_=function(a,b,c){a=sre.SemanticTree.formatXml(a.toString());c?console.log(b+":\n```html\n"+sre.SemanticMathml.removeAttributePrefix(a)+"\n```\n"):console.log(a)};
sre.SemanticMathml.enrich=function(a,b){var c=a.cloneNode(!0);sre.SemanticMathml.walkTree_(b.root);sre.Debugger.getInstance().generateOutput(function(){sre.SemanticMathml.formattedOutput(c,a,b,!0)});return a};
sre.SemanticMathml.walkTree_=function(a){if(1===a.mathml.length){sre.Debugger.getInstance().output("Walktree Case 0");var b=a.mathml[0];sre.SemanticMathml.setAttributes_(b,a);return sre.SemanticMathml.ascendNewNode_(b)}if(b=sre.SemanticMathml.specialCase_(a))return sre.SemanticMathml.ascendNewNode_(b);var b=a.contentNodes.map(sre.SemanticMathml.cloneContentNode_),c=a.childNodes.map(sre.SemanticMathml.walkTree_),c=sre.SemanticMathml.combineContentChildren_(a,b,c),b=a.mathmlTree;if(null===b)sre.Debugger.getInstance().output("Walktree Case 1"),
b=sre.SemanticMathml.introduceNewLayer_(c);else{var d=sre.SemanticMathml.attachedElement_(c);sre.Debugger.getInstance().output("Walktree Case 2");d?(sre.Debugger.getInstance().output("Walktree Case 2.1"),b=d.parentNode):(sre.Debugger.getInstance().output("Walktree Case 2.2"),b=sre.SemanticMathml.getInnerNode_(b))}b=sre.SemanticMathml.rewriteMfenced_(b);sre.SemanticMathml.mergeChildren_(b,c);sre.SemanticMathml.setAttributes_(b,a);return sre.SemanticMathml.ascendNewNode_(b)};
sre.SemanticMathml.introduceNewLayer_=function(a){var b=sre.SemanticMathml.mathmlLca_(a),c=b.node;b.valid&&sre.SemanticUtil.hasEmptyTag(c)||(sre.Debugger.getInstance().output("Walktree Case 1.1"),c=sre.SystemExternal.document.createElement("mrow"),a[0]&&(sre.Debugger.getInstance().output("Walktree Case 1.1.1"),b=sre.SemanticMathml.attachedElement_(a),a=sre.SemanticMathml.childrenSubset_(b.parentNode,a),sre.DomUtil.replaceNode(b,c),a.forEach(function(a){c.appendChild(a)})));return c};
sre.SemanticMathml.childrenSubset_=function(a,b){var c=sre.DomUtil.toArray(a.childNodes),d=Infinity,e=-Infinity;b.forEach(function(a){a=c.indexOf(a);-1!==a&&(d=Math.min(d,a),e=Math.max(e,a))});return c.slice(d,e+1)};sre.SemanticMathml.mergeChildren_=function(a,b){var c=a.childNodes;if(c.length)for(var d=0;b.length;)c[d]===b[0]||sre.SemanticMathml.functionApplication_(c[d],b[0])?(b.shift(),d++):c[d]&&-1===b.indexOf(c[d])?d++:(a.insertBefore(b[0],c[d]),b.shift());else b.forEach(function(b){a.appendChild(b)})};
sre.SemanticMathml.functionApplication_=function(a,b){var c=sre.SemanticAttr.functionApplication();return a&&b&&a.textContent&&b.textContent&&a.textContent===c&&b.textContent===c&&"true"===b.getAttribute(sre.SemanticMathml.Attribute.ADDED)?(sre.DomUtil.replaceNode(a,b),!0):!1};
sre.SemanticMathml.mathmlLca_=function(a){var b=sre.SemanticMathml.attachedElement_(a);if(!b)return{valid:!1,node:null};a=sre.SemanticMathml.attachedElement_(a.slice().reverse());if(b===a)return{valid:!0,node:b};var c=sre.SemanticMathml.pathToRoot_(b),b=sre.SemanticMathml.pathToRoot_(a,function(a){return-1!==c.indexOf(a)});a=b[0];var d=c.indexOf(a);return-1===d?{valid:!1,node:null}:{valid:sre.SemanticMathml.validLca_(c[d+1],b[1]),node:a}};
sre.SemanticMathml.attachedElement_=function(a){for(var b=0,c=null;!c&&b<a.length;)a[b].parentNode&&(c=a[b]),b++;return c};sre.SemanticMathml.simpleCollapseStructure_=function(a){return"number"===typeof a};sre.SemanticMathml.pathToRoot_=function(a,b){for(var c=b||function(a){return!1},d=[a];!c(a)&&!sre.SemanticUtil.hasMathTag(a)&&a.parentNode;)a=sre.SemanticMathml.parentNode_(a),d.unshift(a);return d};sre.SemanticMathml.validLca_=function(a,b){return!(!a||!b||a.previousSibling||b.nextSibling)};
sre.SemanticMathml.ascendNewNode_=function(a){for(;!sre.SemanticUtil.hasMathTag(a)&&sre.SemanticMathml.unitChild_(a);)a=sre.SemanticMathml.parentNode_(a);return a};sre.SemanticMathml.unitChild_=function(a){var b=sre.SemanticMathml.parentNode_(a);return b&&sre.SemanticUtil.hasEmptyTag(b)?sre.DomUtil.toArray(b.childNodes).every(function(b){return b===a||sre.SemanticUtil.hasIgnoreTag(b)}):!1};sre.SemanticMathml.parentNode_=function(a){return a.parentNode};
sre.SemanticMathml.specialCase_=function(a){if(!a.mathmlTree)return null;var b=a.mathmlTree,c=sre.SemanticUtil.tagName(b);return"MSUBSUP"===c&&a.type===sre.SemanticAttr.Type.SUPERSCRIPT||"MUNDEROVER"===c&&a.type===sre.SemanticAttr.Type.OVERSCORE?sre.SemanticMathml.caseDoubleScript_(a,b):a.type===sre.SemanticAttr.Type.TENSOR?sre.SemanticMathml.caseTensor_(a,b):"MMULTISCRIPTS"!==c||a.type!==sre.SemanticAttr.Type.SUPERSCRIPT&&a.type!==sre.SemanticAttr.Type.SUBSCRIPT?a.type===sre.SemanticAttr.Type.LINE?
sre.SemanticMathml.caseLine_(a,b):a.type===sre.SemanticAttr.Type.MATRIX||a.type===sre.SemanticAttr.Type.VECTOR||a.type===sre.SemanticAttr.Type.CASES?sre.SemanticMathml.caseTable_(a,b):null:sre.SemanticMathml.caseMmultiscript_(a,b)};sre.SemanticMathml.caseLine_=function(a,b){a.childNodes.length&&sre.SemanticMathml.walkTree_(a.childNodes[0]);sre.SemanticMathml.setAttributes_(b,a);return b};
sre.SemanticMathml.caseTable_=function(a,b){var c=sre.SemanticMathml.cloneContentNode_(a.contentNodes[0]),d=a.contentNodes[1]?sre.SemanticMathml.cloneContentNode_(a.contentNodes[1]):null;a.childNodes.map(sre.SemanticMathml.walkTree_);"MFENCED"===sre.SemanticUtil.tagName(b)?(b.insertBefore(c,b.childNodes[0]),d&&b.appendChild(d),b=sre.SemanticMathml.rewriteMfenced_(b)):(c=[c,b],d&&c.push(d),b=sre.SemanticMathml.introduceNewLayer_(c));sre.SemanticMathml.setAttributes_(b,a);return b};
sre.SemanticMathml.caseDoubleScript_=function(a,b){var c=a.childNodes[1],d=a.childNodes[0],e=d.childNodes[0],f=d.childNodes[1],g=sre.SemanticMathml.walkTree_(c),h=sre.SemanticMathml.walkTree_(e),k=sre.SemanticMathml.walkTree_(f);sre.SemanticMathml.setAttributes_(b,a);b.setAttribute(sre.SemanticMathml.Attribute.CHILDREN,sre.SemanticMathml.makeIdList_([e,f,c]));[h,k,g].forEach(function(a){sre.SemanticMathml.getInnerNode_(a).setAttribute(sre.SemanticMathml.Attribute.PARENT,b.getAttribute(sre.SemanticMathml.Attribute.ID))});
b.setAttribute(sre.SemanticMathml.Attribute.TYPE,d.role);sre.SemanticMathml.addCollapsedAttribute_(b,[a.id,[d.id,e.id,f.id],c.id]);return b};
sre.SemanticMathml.caseMmultiscript_=function(a,b){sre.SemanticMathml.setAttributes_(b,a);if(a.childNodes[0]&&a.childNodes[0].role===sre.SemanticAttr.Role.SUBSUP){var c=a.childNodes[0],d=c.childNodes[0],e=sre.SemanticMathml.multiscriptIndex_(a.childNodes[1]),f=sre.SemanticMathml.multiscriptIndex_(c.childNodes[1]),g=[a.id,[c.id,d.id,f],e];sre.SemanticMathml.addCollapsedAttribute_(b,g);b.setAttribute(sre.SemanticMathml.Attribute.TYPE,c.role);sre.SemanticMathml.completeMultiscript_(a,b,sre.SemanticMathml.interleaveIds_(f,
e),[])}else d=a.childNodes[0],e=sre.SemanticMathml.multiscriptIndex_(a.childNodes[1]),sre.SemanticMathml.simpleCollapseStructure_(e)||(g=[a.id,d.id,e],sre.SemanticMathml.addCollapsedAttribute_(b,g));c=sre.SemanticMathml.collapsedLeafs_(f||[],e);e=sre.SemanticMathml.walkTree_(d);sre.SemanticMathml.getInnerNode_(e).setAttribute(sre.SemanticMathml.Attribute.PARENT,a.id);c.unshift(d.id);b.setAttribute(sre.SemanticMathml.Attribute.CHILDREN,c.join(","));return b};
sre.SemanticMathml.caseTensor_=function(a,b){sre.SemanticMathml.walkTree_(a.childNodes[0]);var c=sre.SemanticMathml.multiscriptIndex_(a.childNodes[1]),d=sre.SemanticMathml.multiscriptIndex_(a.childNodes[2]),e=sre.SemanticMathml.multiscriptIndex_(a.childNodes[3]),f=sre.SemanticMathml.multiscriptIndex_(a.childNodes[4]);sre.SemanticMathml.setAttributes_(b,a);var g=[a.id,c,d,e,f];g.every(sre.SemanticMathml.simpleCollapseStructure_)||sre.SemanticMathml.addCollapsedAttribute_(b,g);g=sre.SemanticMathml.collapsedLeafs_(c,
d,e,f);g.unshift(a.childNodes[0].id);b.setAttribute(sre.SemanticMathml.Attribute.CHILDREN,g.join(","));sre.SemanticMathml.completeMultiscript_(a,b,sre.SemanticMathml.interleaveIds_(e,f),sre.SemanticMathml.interleaveIds_(c,d));return b};sre.SemanticMathml.interleaveIds_=function(a,b){return sre.SemanticMathml.interleaveLists_(sre.SemanticMathml.collapsedLeafs_(a),sre.SemanticMathml.collapsedLeafs_(b))};
sre.SemanticMathml.collapsedLeafs_=function(a){var b=function(a){return sre.SemanticMathml.simpleCollapseStructure_(a)?[a]:a.slice(1)};return Array.prototype.slice.call(arguments,0).reduce(function(a,d){return a.concat(b(d))},[])};sre.SemanticMathml.addCollapsedAttribute_=function(a,b){var c=function(a){return sre.SemanticMathml.simpleCollapseStructure_(a)?a.toString():"("+a.map(c).join(" ")+")"};a.setAttribute(sre.SemanticMathml.Attribute.COLLAPSED,c(b))};
sre.SemanticMathml.completeMultiscript_=function(a,b,c,d){var e=sre.DomUtil.toArray(b.childNodes).slice(1),f=0,g=function(c){for(var d=0,g;g=c[d];d++){var n=e[f];if(n&&g==sre.SemanticMathml.getInnerNode_(n).getAttribute(sre.SemanticMathml.Attribute.ID))sre.SemanticMathml.getInnerNode_(n).setAttribute(sre.SemanticMathml.Attribute.PARENT,a.id),f++;else{var m=a.querySelectorAll(function(a){return a.id===g});b.insertBefore(sre.SemanticMathml.createNone_(m[0]),n)}}};g(c);e[f]&&"MPRESCRIPTS"!==sre.SemanticUtil.tagName(e[f])?
b.insertBefore(e[f],sre.SystemExternal.document.createElement("mprescripts")):f++;g(d)};sre.SemanticMathml.createNone_=function(a){var b=sre.SystemExternal.document.createElement("none");a&&sre.SemanticMathml.setAttributes_(b,a);b.setAttribute(sre.SemanticMathml.Attribute.ADDED,"true");return b};
sre.SemanticMathml.multiscriptIndex_=function(a){if(a.type===sre.SemanticAttr.Type.PUNCTUATED&&a.contentNodes[0].role===sre.SemanticAttr.Role.DUMMY){for(var b=a.role,c=a.parent.id,d=[a.id],e=0,f;f=a.childNodes[e];e++){var g=sre.SemanticMathml.walkTree_(f),g=sre.SemanticMathml.getInnerNode_(g);g.setAttribute(sre.SemanticMathml.Attribute.PARENT,c);g.setAttribute(sre.SemanticMathml.Attribute.ROLE,b);d.push(f.id)}return d}sre.SemanticMathml.walkTree_(a);return a.id};
sre.SemanticMathml.cloneContentNode_=function(a){if(a.mathml.length)return sre.SemanticMathml.walkTree_(a);var b=sre.SemanticMathml.SETTINGS.implicit?sre.SemanticMathml.createInvisibleOperator_(a):sre.SystemExternal.document.createElement("mrow");a.mathml=[b];return b};sre.SemanticMathml.makeIdList_=function(a){return a.map(function(a){return a.id}).join(",")};sre.SemanticMathml.makeIdListOld_=function(a){return a.map(function(a){return a.getAttribute(sre.SemanticMathml.Attribute.ID)}).join(",")};
sre.SemanticMathml.setAttributes_=function(a,b){a.setAttribute(sre.SemanticMathml.Attribute.TYPE,b.type);a.setAttribute(sre.SemanticMathml.Attribute.ROLE,b.role);a.setAttribute(sre.SemanticMathml.Attribute.ID,b.id);b.childNodes.length&&a.setAttribute(sre.SemanticMathml.Attribute.CHILDREN,sre.SemanticMathml.makeIdList_(b.childNodes));b.contentNodes.length&&a.setAttribute(sre.SemanticMathml.Attribute.CONTENT,sre.SemanticMathml.makeIdList_(b.contentNodes));b.parent&&a.setAttribute(sre.SemanticMathml.Attribute.PARENT,
b.parent.id)};
sre.SemanticMathml.combineContentChildren_=function(a,b,c){sre.SemanticMathml.setOperatorAttribute_(a,b);switch(a.type){case sre.SemanticAttr.Type.RELSEQ:case sre.SemanticAttr.Type.INFIXOP:case sre.SemanticAttr.Type.MULTIREL:return sre.SemanticMathml.interleaveLists_(c,b);case sre.SemanticAttr.Type.PREFIXOP:return b.concat(c);case sre.SemanticAttr.Type.POSTFIXOP:return c.concat(b);case sre.SemanticAttr.Type.FENCED:return c.unshift(b[0]),c.push(b[1]),c;case sre.SemanticAttr.Type.PUNCTUATED:if(a.role===sre.SemanticAttr.Role.TEXT)return sre.SemanticMathml.interleaveLists_(c,
b);for(var d=[],e=0,f=0,g,h;g=c[e],h=b[f];e++)g.getAttribute(sre.SemanticMathml.Attribute.ID)==h.getAttribute(sre.SemanticMathml.Attribute.ID)&&(f++,d.push(g));sre.SemanticMathml.setOperatorAttribute_(a,d);return c;case sre.SemanticAttr.Type.APPL:return[c[0],b[0],c[1]];case sre.SemanticAttr.Type.ROOT:return[c[1],c[0]];default:return c}};
sre.SemanticMathml.rewriteMfenced_=function(a){if("MFENCED"!==sre.SemanticUtil.tagName(a))return a;for(var b=sre.SystemExternal.document.createElement("mrow"),c=0,d;d=a.attributes[c];c++)-1===["open","close","separators"].indexOf(d.name)&&b.setAttribute(d.name,d.value);sre.DomUtil.toArray(a.childNodes).forEach(function(a){b.appendChild(a)});sre.DomUtil.replaceNode(a,b);return b};
sre.SemanticMathml.createInvisibleOperator_=function(a){var b=sre.SystemExternal.document.createElement("mo"),c=sre.SystemExternal.document.createTextNode(a.textContent);b.appendChild(c);sre.SemanticMathml.setAttributes_(b,a);b.setAttribute(sre.SemanticMathml.Attribute.ADDED,"true");return b};
sre.SemanticMathml.setOperatorAttribute_=function(a,b){var c=a.type+(a.textContent?","+a.textContent:"");b.forEach(function(a){sre.SemanticMathml.getInnerNode_(a).setAttribute(sre.SemanticMathml.Attribute.OPERATOR,c)})};
sre.SemanticMathml.getInnerNode_=function(a){var b=sre.DomUtil.toArray(a.childNodes);if(!b)return a;for(var b=b.filter(function(a){return a.nodeType===sre.DomUtil.NodeType.ELEMENT_NODE&&!sre.SemanticUtil.hasIgnoreTag(a)}),c=[],d=0,e;e=b[d];d++)if(sre.SemanticUtil.hasEmptyTag(e)){var f=sre.SemanticMathml.getInnerNode_(e);f&&f!==e&&c.push(f)}else c.push(e);return 1===c.length?c[0]:a};
sre.SemanticMathml.interleaveLists_=function(a,b){for(var c=[];a.length||b.length;)a.length&&c.push(a.shift()),b.length&&c.push(b.shift());return c};sre.SemanticMathml.removeAttributePrefix=function(a){return a.toString().replace(new RegExp(sre.SemanticMathml.ATTRIBUTE_PREFIX_,"g"),"")};sre.SemanticMathml.printNodeList__=function(a,b){console.log(a);sre.DomUtil.toArray(b).forEach(function(a){console.log(a.toString())});console.log("<<<<<<<<<<<<<<<<<")};
sre.SemanticMathml.testTranslation__=function(a){sre.Debugger.getInstance().init();sre.SemanticMathml.removeAttributePrefix(sre.Semantic.enrichMathml("<math>"+a+"</math>").toString())};sre.Semantic={};sre.Semantic.Font=sre.SemanticAttr.Font;sre.Semantic.Role=sre.SemanticAttr.Role;sre.Semantic.Type=sre.SemanticAttr.Type;sre.Semantic.getTree=function(a){return(new sre.SemanticTree(a)).xml()};sre.Semantic.getTreeFromString=function(a){a=sre.DomUtil.parseInput(a);return(new sre.SemanticTree(a)).xml()};sre.Semantic.enrichMathml=function(a){a=sre.DomUtil.parseInput(a);return sre.Semantic.annotateMathml(a)};
sre.Semantic.annotateMathml=function(a){a=a.cloneNode(!0);var b=new sre.SemanticTree(a);return sre.SemanticMathml.enrich(a,b)};
